namespace ClassLibrary
{
    public class LightCar : Avto
    {
        ...
        public LightCar(string brand, int year, string color, int price, int groundClearance, int seats, int maxSpeed) :
